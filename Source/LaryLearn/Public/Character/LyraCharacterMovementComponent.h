...
LARYLEARN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_MovementStopped);
...
UCLASS()
class LARYLEARN_API ULyraCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
public:
